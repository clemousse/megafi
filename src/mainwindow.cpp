...
MainWindow::MainWindow(QWidget *parent) :
    ...
    m_progressBar(),
    m_contextMenu(), m_selectedItem(NULL)
{
    ...
    {
        QList<QAction*> actions = { ui->actionCMRename, ui->actionCMCustomize, ui->actionCMDelete };
...
void MainWindow::editFlowPath()
{
    ui->pathList->editItem(m_selectedItem);
}

void MainWindow::customizeFlowPath()
{
    changeFlowPathProperties(m_selectedItem);
}

void MainWindow::deleteFlowPath()
{
    FlowPath* flow = static_cast<FlowPath*>(m_selectedItem);
    ...
    ui->pathList->removeItemWidget(m_selectedItem);
...
{
    m_selectedItem = ui->pathList->itemAt(p);
    m_contextMenu.exec;
}
